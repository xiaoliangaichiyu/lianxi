...
//d = '{"id":2082326624,"lv":-1,"tv":-1,"csrf_token":"db9f233dd05de941d8c19d94eaf9f14f"}'
//定义一个方法封装上面函数
function getsign(d){
    ...
    g = '0CoJUm6Qyw8W8jud'
    var bVz0x = asrsea(JSON.stringify(d), e, f, g);
    return bVz0x
}
...
// bsC5H = function(cyw4A) {
//         var m0x = [];
//         j0x.bh0x(cyw4A, function(cyv4z) {
//             m0x.push(BA5F.emj[cyv4z])
//         });
//         return m0x.join("")
//     };
